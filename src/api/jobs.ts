...
export const MOCK_JOBS: Job[] = [
  {
    ...
    isActive: true,
    applicants: [
      { id: "a1", name: "Elvin Həsənov", initials: "EH", color: "bg-blue-500", stage: "applied", rating: 4, appliedAt: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString() },
      { id: "a2", name: "Nigar Abbasova", initials: "NA", color: "bg-purple-500", stage: "screening", rating: 3, appliedAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString() }
    ],
  ...
  },
  {
    ...
    isActive: true,
    applicants: [
      { id: "a3", name: "Zaur Əliyev", initials: "ZƏ", color: "bg-emerald-500", stage: "interview", rating: 5, appliedAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString() }
    ],
