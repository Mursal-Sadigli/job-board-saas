      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* E-poçt Bildirişləri */}
            <div className="bg-card dark:bg-white/5 border border-border dark:border-white/10 rounded-[2.5rem] p-8 shadow-xl shadow-shadow/5 relative overflow-hidden backdrop-blur-xl transition-colors">
              ...
              <div className="space-y-6">
                <div className="flex items-start justify-between gap-6">
                  ...
                  <Switch checked={settings.newApplications} onCheckedChange={() => toggleSetting('newApplications')} className="dark:data-[state=unchecked]:bg-white/10" />
                </div>
                <div className="h-px bg-border dark:bg-white/5 max-w-sm" />
                ...
                <div className="flex items-start justify-between gap-6">
                  ...
                  <Switch checked={settings.dailyDigest} onCheckedChange={() => toggleSetting('dailyDigest')} className="dark:data-[state=unchecked]:bg-white/10" />
                </div>
                <div className="h-px bg-border dark:bg-white/5 max-w-sm" />
                ...
                <div className="flex items-start justify-between gap-6">
                  ...
                  <Switch checked={settings.candidateMessages} onCheckedChange={() => toggleSetting('candidateMessages')} className="dark:data-[state=unchecked]:bg-white/10" />
                </div>
              </div>
            </div>

            {/* Sistem və Yeniliklər */}
            <div className="bg-card dark:bg-white/5 border border-border dark:border-white/10 rounded-[2.5rem] p-8 shadow-xl shadow-shadow/5 backdrop-blur-xl transition-colors">
              <h3 className="text-lg font-black text-foreground mb-8 flex items-center gap-3">
              ...
              <div className="space-y-6">
                <div className="flex items-start justify-between gap-6">
                  ...
                  <Switch checked={settings.jobExpiry} onCheckedChange={() => toggleSetting('jobExpiry')} className="dark:data-[state=unchecked]:bg-white/10" />
                </div>
                <div className="h-px bg-border dark:bg-white/5 max-w-sm" />
                ...
                <div className="flex items-start justify-between gap-6">
                  ...
                  <Switch checked={settings.platformUpdates} onCheckedChange={() => toggleSetting('platformUpdates')} className="dark:data-[state=unchecked]:bg-white/10" />
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            {/* Push Notifications */}
            <div className="bg-primary text-primary-foreground rounded-[2.5rem] p-8 shadow-2xl shadow-primary/20 relative overflow-hidden transition-all">
              ...
              <p className="text-sm text-primary-foreground/90 mb-6 leading-relaxed relative z-10">
                Brauzerinizdən çıxsanız belə dərhal ekranınıza bildirişlərin gəlməsini istəyirsiniz?
              </p>

              <div className="flex items-center justify-between bg-black/20 dark:bg-black/40 rounded-2xl p-4 border border-white/10 relative z-10 backdrop-blur-md">
                <span className="font-bold text-sm">Aktivləşdir</span>
                <Switch 
                  checked={settings.pushNotifications} 
                  onCheckedChange={() => toggleSetting('pushNotifications')}
                  className="data-[state=checked]:bg-white data-[state=checked]:border-white dark:data-[state=unchecked]:bg-white/10"
                />
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select value={minRating} onValueChange={(v) => setMinRating(v ?? "any")}>
                    <SelectTrigger className="w-full bg-muted/50 dark:bg-white/5 border-border dark:border-white/10 rounded-xl h-12 font-medium">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent className="bg-card dark:bg-slate-900 border-border dark:border-white/10 rounded-xl">
                ...
                <p className="text-[11px] text-muted-foreground leading-relaxed bg-muted/50 dark:bg-white/5 p-4 rounded-xl border border-border/50 dark:border-white/10 font-medium">
